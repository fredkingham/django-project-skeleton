...
# we don't use this, static files should be done using brunch httpd://brunch.io
# go to the front_end dir and run brunch watch
STATIC_ROOT = "%s/madeup/" % SITE_ROOT
...
STATICFILES_DIRS = (
    "%s/front_end/static/public" % SITE_ROOT
